...
const RoomDetails = (props: {params: {slug: string} }) => {
   ...
   const {data: room, error, isLoading} = useSWR("/api/room", fetchRoom);
    ...
    if (typeof room === "undefined" && !isLoading)
      ...
      if(checkinDate > checkoutDate) return toast.error("the checkin date can't be greater than checkout date");
      ...
      try {
        ...
        toast.error("An error occured here")
      }
      };
       const calcNumDays = () => {
        ...
        <div className="md:grid md:grid-cols-12 gap-10 px-3">
          <div className="md:col-span-8 md:w-full">
            <div>
              ...
              <div className="mb-11">
                <h2 className="font-bold text-3xl mb-2 ">safety and Hygiens</h2>
                <div className="grid grid-cols-2">
                  ...
                  <div className="flex items-center my-1 md:my-0">
                    ...
                    <p className="ml-2 md:text-base text-xs">
                      Disinfections and Sterizations
                    </p>
                  </div>
                  <div className="flex items-center my-1 md:my-0">
                    <GiSmokeBomb />
